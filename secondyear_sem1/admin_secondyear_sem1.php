        ...
        <div class="module-section">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="php_secondyear_sem1/logout.php"><span class="icon">&#10162;</span>&nbsp;<p>Logout</p></a></li>
                </ul>
            ...
            <div class="contents">
                ...
                <div class="contents2">
                    <div class="contents-holder" id="admin_home">
                        ...
                        <form action="php_secondyear_sem1/uploads.php" method="post" enctype="multipart/form-data" required>
                            <div class="inputs">
                            ...
                            <div class="inputs">
                                ...
                                <select name="task_module" id="" required>
                                    ...
                                    <option value="Operating System Adminstration">Operating System Adminstration</option>
                                    <option value="Data Communication">Data Communication</option>
                                    <option value="Data Structure and Algorithims">Data Structure and Algorithims</option>
                                    <option value="Electronic Commerce">Electronic Commerce</option>
                                    <option value="Develompment Studies">Develompment Studies</option>
                    ...
                    <div class="contents-holder" id="ChangePassword" style="display: none;">
                        <div class="form-holder">
                            ...
                            <form action="php_secondyear_sem1/change_password.php" method="post">
                                <div class="inputs">
                        ...
                        <div class="form-holder">
                            ...
                            ?>
                                <div class="profile-img">
                                    <img src="php_secondyear_sem1/<?php echo $row_user['profileimage']; ?>" alt="">

                                </div>
                                <form action="php_secondyear_sem1/update_profile.php" method="post" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="php_secondyear_sem1/deletenotes.php" method="post">
