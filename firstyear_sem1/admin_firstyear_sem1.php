        ...
        <div class="module-section">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="php_firstyear_sem1/logout.php"><span class="icon">&#10162;</span>&nbsp;<p>Logout</p></a></li>
                </ul>
            ...
            <div class="contents">
                ...
                <div class="contents2">
                    <div class="contents-holder" id="admin_home">
                        ...
                        <form action="php_firstyear_sem1/uploads.php" method="post" enctype="multipart/form-data" required>
                            <div class="inputs">
                            ...
                            <div class="inputs">
                                ...
                                <select name="task_module" id="" required>
                                    <option value="Programing (C)">Programing (C)</option>
                                    <option value="B/Communication Skills">B/Communication Skills</option>
                                    <option value="C/Archtecture & Design">C/Archtecture & Design</option>
                                    <option value="B/Information System">B/Information System</option>
                    ...
                    <div class="contents-holder" id="ChangePassword" style="display: none;">
                        <div class="form-holder">
                            ...
                            <form action="php_firstyear_sem1/change_password.php" method="post">
                                <div class="inputs">
                        ...
                        <div class="form-holder">
                            ...
                            ?>
                                <div class="profile-img">
                                    <img src="php_firstyear_sem1/<?php echo $row_user['profileimage']; ?>" alt="">

                                </div>
                                <form action="php_firstyear_sem1/update_profile.php" method="post" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="php_firstyear_sem1/deletenotes.php" method="post">
