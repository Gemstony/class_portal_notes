    ...
    if (in_array($fileExt, $allowed)) {
        if ($fileError === 0) {
            if ($fileSize > $maxFilesize) {
                ...
                header("Location: ../admin_firstyear_sem1.php");
                die();
            }
            ...
            if (move_uploaded_file($fileTmpName, $fileDestination)) {
                ...
                VALUES ('$task_name', '$task_type', '$task_module', '$fileName', '$fileDestination', 'FIRST', 'ONE', '$myid')";
                ...
                window.location.href='../admin_firstyear_sem1.php';
                </script>;");
            }
        }
    } else {$_SESSION['invalidfile'] = "invalid file, Ony PDF or DOC allowed";
            header("Location: ../admin_firstyear_sem1.php");
            die();
        }
}
