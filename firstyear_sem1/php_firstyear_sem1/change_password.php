...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if ($results->num_rows > 0){
        if ($new_password == $verify_new_password){
            ...
            $_SESSION['passwordChanged'] = "Password Changed Seuccessfully";
            ...
            $_SESSION['verifyingError'] = "Incorrect Verifying password  ";
            
           
        }  
        
    }else{
        $_SESSION['wrongOldPassword'] = "Wrong Old password please Try again ";
